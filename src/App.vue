<template>
  <div class="container">
    ...
    <div class="row">
      <div class="col"><button type="button" :disabled="disableButton(0, 0)"
          @click="() => onClick(0, 0)">{{ board[0][0] }}</button></div>
      <div class="col"><button type="button" :disabled="disableButton(0, 1)"
          @click="() => onClick(0, 1)">{{ board[0][1] }}</button></div>
      <div class="col"><button type="button" :disabled="disableButton(0, 2)"
          @click="() => onClick(0, 2)">{{ board[0][2] }}</button></div>
    </div>
    <div class="row">
      <div class="col"><button type="button" :disabled="disableButton(1, 0)"
          @click="() => onClick(1, 0)">{{ board[1][0] }}</button></div>
    ...
    <div class="row">
      <div class="col"><button type="button" :disabled="disableButton(2, 0)"
          @click="() => onClick(2, 0)">{{ board[2][0] }}</button></div>
